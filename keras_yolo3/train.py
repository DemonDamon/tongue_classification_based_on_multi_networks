...
# options.annotation_path = './annotate.txt'
# options.log_dir = './logs/000/'
# options.classes_path = './model_data/tongue_classes.txt'
# options.anchors_path = './model_data/yolo_anchors.txt'

class_names = get_classes(options.classes_path)
num_classes = len(class_names)
anchors = get_anchors(options.anchors_path)

assert options.annotation_path != None
assert options.classes_path != None
assert options.anchors_path != None
...
if True:
    ...
    model.save_weights(options.log_dir + 'trained_weights_stage_1.h5')
...
if True:
    ...
    model.save_weights(options.log_dir + 'trained_weights_final.h5')
...
#
# def _main():
#     annotation_path = './annotate.txt'
#     log_dir = './logs/000/'
#     classes_path = './model_data/tongue_classes.txt'
