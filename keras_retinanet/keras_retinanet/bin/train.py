...
def parse_args(args):
    ...
    parser.add_argument('--epochs',           help='Number of epochs to train.', type=int, default=10) #10
    parser.add_argument('--steps',            help='Number of steps per epoch.', type=int, default=100) #100
...
def main(args=None):
    ...
    print(' [*] created object that stores backbone information...')
    ...
    if args.config:
        ...
        print(' [*] optionally loaded config parameters...')

    # create the generators
    train_generator, validation_generator = create_generators(args, backbone.preprocess_image)
    print(' [*] created the data generator of both train and validation...')
